...
key.",
    ...
    "regionName": {
      "description": "The name of the region for which the key is valid
(e.g. covers all subtaxa).",
      "comment": "Accepts array for multilingual support.",
      "$ref": "#/definitions/localizedString",
      "examples": [
        "Norway",
    ...
    "geography": {
      "description": "The region for which the key is valid (e.g. covers
all subtaxa), represented as the coordinates array of a GeoJSON
MultiPolygon.",
...
contact point for the key.",
    ...
    "publisher": {
      "description": "The id(s) of the publising institutions of the
key.",
      "oneOf": [
        {
          "$ref": "#/definitions/organizationID"
...
localizedString and localizedUrl as arrays too.",
    ...
    "created": {
      "description": "The moment the key was made or first published, as
'YYYY-MM-DD hh:mm:ss'.",
      "type": "string",
...
version).",
    ...
    "url": {
      "description": "The url of where the key lives (to check for newer
versions).",
      "$ref": "#/definitions/url"
    },
    "externalServices": {
...
characters, so that the user can be warned, helped, etc.",
    ...
    "taxa": {
      "description": "Taxa (e.g. species) the key can resolve to. Do not
have to be exclusively taxonomic units.",
      "comment": "Taxa to which the key can resolve. Either the taxa
directly or their children. SubTaxonomic taxa (such as morphs, genders,
life stages) should be presented through their parent only.",
      "type": "array",
      "items": {
...
(or lack thereof) that define those taxa.",
    ...
    "persons": {
      "description": "Persons that are connected to (parts of) the key,
such as creators.",
      "type": "array",
      "items": {
    ...
    "organizations": {
      "description": "Organizations that are connected to (parts of) the
key or persons, such as employers and publishers.",
      "type": "array",
      "items": {
...
media elements, corresponding to the languages supported by the key.",
      "properties": {
        "id": {
...
file falls.",
    ...
    "mediaElement": {
      "description": "A media element (collection of various formats of
...
externalService.",
    ...
    "externalService": {
      "description": "Service used by the key, for media files, taxonomy
and/or nomenclature, species distributions, etc.",
      "type": "object",
      "required": [
        "id"
      ],
    ...
    "state": {
      ...
      "properties": {
        ...
        "title": {
          ...
          "comment": "Only to be used for catergorical characters.
